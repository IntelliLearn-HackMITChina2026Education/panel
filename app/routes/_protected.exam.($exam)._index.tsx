            ...
            <SidebarInset>
                ...
                <header className="flex h-16 items-center gap-2 px-4">
                    ...
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbItem>
                                <BreadcrumbPage>概况</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </header>
                ...
                <div className="space-y-6 p-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                        <StatCard title="平均分" value={stats.avg}/>
                        <StatCard title="及格率" value={stats.passRate} suffix="%"/>
                        <StatCard title="优秀率" value={stats.excellentRate} suffix="%"/>
                        <StatCard title="最高分" value={stats.max}/>
                        <StatCard title="标准差" value={stats.std}/>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        ...
                        <Card>
                            ...
                            <CardContent className="text-sm text-muted-foreground leading-6">
                                本次考试整体难度中等偏高，平均分略低于历史水平。主要失分集中在函数极限与导数应用，
                                建议针对这两个知识点进行重点复习与分层训练。同时优秀率偏低，说明高分段学生区分度不足，
                                可增加综合性题目训练。
                            </CardContent>
                        </Card>
                    </div>
